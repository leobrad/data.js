...
describe('[class] Users clear records cache test case;', () => {
  test('select first arbitrarliy record;', async () => {
    const users = await global.user.tb.select([2, 8], ['age', 'city', 'country'], true);
  ...
  test('select second arbitrarliy record;', async () => {
    const users = await global.user.tb.select([4, 9], ['id', 'age'], true);
  ...
  test('select third arbitrarliy record;', async () => {
    const users = await global.user.tb.select([6, 8], ['gender', 'country'], true);
  ...
  test('select fourth arbitrarliy record;', async () => {
    const users = await global.user.tb.select([4, 12], ['name', 'city'], true);
  ...
  test('select fifth arbitrarliy record;', async () => {
    const users = await global.user.tb.select([7, 9], ['id', 'gender', 'country'], true);
